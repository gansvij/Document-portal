...
# installed.
TCL_PREFIX='F:/Gen_AI/Krish_naik/Krish_Advance_NLP_Gen_AI_Bootcamp_practice/Document portal/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='F:/Gen_AI/Krish_naik/Krish_Advance_NLP_Gen_AI_Bootcamp_practice/Document portal/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='F:/Gen_AI/Krish_naik/Krish_Advance_NLP_Gen_AI_Bootcamp_practice/Document portal/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IF:/Gen_AI/Krish_naik/Krish_Advance_NLP_Gen_AI_Bootcamp_practice/Document portal/venv\Library\include'
...
TCL_PACKAGE_PATH='F:/Gen_AI/Krish_naik/Krish_Advance_NLP_Gen_AI_Bootcamp_practice/Document portal/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LF:/Gen_AI/Krish_naik/Krish_Advance_NLP_Gen_AI_Bootcamp_practice/Document portal/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='F:/Gen_AI/Krish_naik/Krish_Advance_NLP_Gen_AI_Bootcamp_practice/Document portal/venv\Library\lib\tclstub86.lib'
